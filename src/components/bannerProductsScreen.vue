<template>
      ...
      <div class="content-container">
        <div class="main-content">
          ...
          <div class="main-banner">
            <div class="banner-container" :style="{ transform: `translateX(-${currentSlide * 100}%)` }">
  ...
  // 배너 슬라이드 상태
  const banners = ref([
    { title: "Banner 1", image: require("@/assets/images/banner/cat.jpg") },
    { title: "Banner 2", image: require("@/assets/images/banner/dog.jpg") },
    { title: "Banner 3", image: require("@/assets/images/banner/puppy.jpg") },
    { title: "Banner 4", image: require("@/assets/images/banner/spitz.jpg") }
  ]);
  ...
  const prevSlide = () => currentSlide.value = currentSlide.value === 0 ? banners.value.length - 1 : currentSlide.value - 1;
